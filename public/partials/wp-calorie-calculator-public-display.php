...
$unit = isset($atts['unit']) ? $atts['unit'] : '';
$metric_system = ($unit == 'm');
$notification_email = isset($atts['res']) ? $atts['res'] : '';
$primary_color = isset($atts['color1']) ? $atts['color1'] : '';
$secondary_color = isset($atts['color2']) ? $atts['color2'] : '';
?>
